...
特にバックエンドが面白く、WEBアプリを何とか作成しましたが、広大な海の中の小さな魚になった気分になりました。。。orz
エンジニアの世界は広くて深いですね、、、。コツコツ積み上げた先に見えてくる世界が楽しみです！
...
現在SQLを猛勉強中。また今まで作成したWEBアプリの中身をブラッシュアップするべくこちらも学習中。
バックエンド深掘り後は、Reactでフロントを実装して、今あるWEBアプリをAPI化したい。
インフラももっと知識を深掘りしたい、、、と自身のフルスタック化へ邁進中。
